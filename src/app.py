...
activities = {
    ...
    "Basketball Team": {
        "description": "Develop basketball skills through drills, scrimmages, and competitions",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Practice soccer fundamentals and play friendly matches",
    ...
    "Drama Club": {
        "description": "Build acting, stage presence, and performance skills",
